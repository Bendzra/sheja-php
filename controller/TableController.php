...
include_once dirname(__DIR__) . "/parser/TableParserHandler.php";
...
class TableController
{
    ...
    static function doGet()
    {
        ...
        $handler = new TableParserHandler(ShejaController::$bookShelf->getBooks()[$book_id - 1], $drop_id, $crumb_id);
